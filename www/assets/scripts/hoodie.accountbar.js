...
//     this.hoodie = hoodie;
//     this.$html = $('html');
//     this.$accountbar = $('.hoodie-accountbar');
...
//       this.hoodie.account
//         .on('signin', this.handleUserAuthenticated.bind(this));
//       this.hoodie.account
//         .on('signout', this.handleUserUnauthenticated.bind(this));
//       this.hoodie
//         .on('account:error:unauthenticated remote:error:unauthenticated', this.handleUserAuthenticationError.bind(this));
//     },

//     handleUserAuthenticated: function(username) {
//       this.$html.attr('data-hoodie-account-status', 'signedin');
//       this.$accountbar.find('.hoodie-username').text(username);
//     },

//     handleUserUnauthenticated: function() {
//       this.$html.attr('data-hoodie-account-status', 'signedout');
//     },

//     handleUserAuthenticationError: function() {
//       this.$accountbar.find('.hoodie-username').text(this.hoodie.account.username);
//       this.$html.attr('data-hoodie-account-status', 'error');
//     }
//   };
